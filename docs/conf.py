...
"""
super-csv documentation build configuration file.
...
#
html_theme_options = {
 "repository_url": "https://github.com/openedx/super-csv",
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     author, project_title, 'CSV Processor',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'super_csv'),
                os.path.join(root_path, 'super_csv/migrations')])

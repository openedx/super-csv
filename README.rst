...
#. Clone inside the lms, uninstall super-csv and reinstall your local copy. You can run the following line from inside the lms,
   or from the host machine run ``make install-local`. This is necessary if one wants to use latest version for testing/development purposes::
